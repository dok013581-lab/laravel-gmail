...
<head>
    ...
    <title>500 - Lỗi máy chủ | TaskManager</title>
...
<body>
    ...
    <div class="error-card">
        ...
        <span class="error-badge">500 SERVER ERROR</span>

        <h1>Đã xảy ra lỗi máy chủ</h1>

        <p>
            Hệ thống đang gặp sự cố kỹ thuật tạm thời. Chúng tôi đang tiến hành xử lý, vui lòng thử lại sau ít phút.
        </p>
